...
function isNull(prop) {
  return prop === null || 'undefined' === prop || 'undefined' === typeof prop || undefined === _typeof(prop) || 'null' === prop;
}
...
var invokeFlutterCommonChannel = function invokeFlutterCommonChannel(invokeData, callback) {
